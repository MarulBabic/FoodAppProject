...
import my.food.foodapp.Activity.ListFoodsActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.viewholder holder, int position) {
        ...
        ,"drawable",holder.itemView.getContext().getPackageName());                                 //dohvacamo resurs slike iz drawable direktorij na temelju putanje slike koja se nalazi u items na odredenoj poziciji
