...
package my.food.foodapp.Helper;
...
public class TinyDB {
    ...
    public ArrayList<Foods> getListObject(String key){        // metoda omogucuje dohvacanje liste objekata tipa foods spremljenih pod odredenim kljucem u sharedpreferences
        Gson gson = new Gson();
